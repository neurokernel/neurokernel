...
num_dendrites = read_file('lamina/n_dendrites.h5').astype(np.int32)
num_neurons = num_dendrites.size
pre_neuron = read_file('lamina/pre.h5').astype(np.int32)
num_synapse = pre_neuron.size
post_neuron = read_file('lamina/post.h5').astype(np.int32)
thres = read_file('lamina/threshold.h5')
slope = read_file('lamina/slope.h5')
power = read_file('lamina/power.h5')
saturation = read_file('lamina/saturation.h5')
delay = read_file('lamina/delay.h5')
reverse = read_file('lamina/reverse.h5')

start_idx = read_file('lamina/start_idx.h5').astype(np.int32)
num_types = start_idx.size
V_1 = read_file('lamina/V1.h5')
V_2 = read_file('lamina/V2.h5')
V_3 = read_file('lamina/V3.h5')
V_4 = read_file('lamina/V4.h5')
Tphi = read_file('lamina/T.h5')
offset = read_file('lamina/offset.h5')

#intial condition at resting potential
V = read_file('lamina/initV.h5')
n = read_file('lamina/initn.h5')
...
#input video
#h_I_ext = read_file('videos/flicker_stripe_same6.h5') * 4
h_I_ext = np.zeros(10000, 4608) #read_file('videos/polar_motion.h5')
