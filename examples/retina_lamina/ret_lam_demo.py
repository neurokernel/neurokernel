...
if args.output:
    if args.video:
        eyemodel.visualise_output(media_file=RET_OUTPUT_AVI,
                                  model_output=RET_OUTPUT_GPOT,
                                  config = {'LPU': 'retina', 'type':'video'} )
        if not args.retina_only:
            eyemodel.visualise_output(media_file=LAM_OUTPUT_AVI,
                                      model_output=LAM_OUTPUT_GPOT,
                                      config = {'LPU': 'lamina', 'type':'video',
                                                'neuron': 'L1'} )
    else:
