NEURON_LIST = [
    ...
    {'name':'Am', 'model':'MorrisLecar', 'columnar':False,
     'num':350, 'output':True, 'extern':False, 'public':False, 'spiking':False,
     'V1': -0.001, 'V2':0.015, 'V3': 0, 'V4': 0.03, 'phi':0.2,
...
SYNAPSE_LIST = [
    ...
    { 'prename':'a1', 'postname':'L3', 'model':'power_gpot_gpot',
      'cart':None, 'reverse':0, 'delay':1, 'threshold':-0.05284,
    ...
    #
    { 'prename':'L2', 'postname':'L4', 'model':'power_gpot_gpot',
      'cart':None, 'reverse':0, 'delay':1, 'threshold':-0.0505,
      'slope':2, 'power':1, 'saturation':0.03, 'scale':4,
      'mode':0 },
    ...
    { 'prename':'C3', 'postname':'L2', 'model':'power_gpot_gpot',
      'cart':None, 'reverse':-0.07, 'delay':1, 'threshold':-0.05,
      'slope':1, 'power':1, 'saturation':0.02, 'scale':5,
      'mode':0 },
    ...
    { 'prename':'a4', 'postname':'C2', 'model':'power_gpot_gpot',
      'cart':None, 'reverse':0, 'delay':1, 'threshold':-0.05184,
