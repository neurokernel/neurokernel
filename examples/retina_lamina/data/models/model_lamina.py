...
NEURON_LIST = [
    ...
    {'name':'Am', 'model':'MorrisLecar_a', 'columnar':False, 'output':False,
    'extern':False, 'public':False, 'spiking':False, 'num': 350,
    'V1':-20.0, 'V2':50.0, 'V3':-40.0, 'V4':20.0,
    'V_l':-40.0, 'V_ca':120.0, 'V_k':-80.0,
    'G_l':3.0, 'G_ca':4.0, 'G_k':16.0,
    'phi':0.001, 'initV':-48.57, 'initn':0.3525, 'offset':0.0}
...
SYNAPSE_LIST = [
    ...
    'threshold':-46.0, 'slope':0.02, 'power':0.1, 'saturation':10.0,
    'scale':100, 'mode':0},
